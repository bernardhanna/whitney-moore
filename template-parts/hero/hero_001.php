...
>
  ...
  <?php endif; ?>
    <div class="gap-2 items-center flex justify-end max-w-container mx-auto min-h-[878px] px-5 w-full <?php echo esc_attr(implode(' ', $padding_classes)); ?>">
        <div class="flex relative flex-col justify-center self-stretch p-[2px] my-auto border-solid min-w-60 w-[627px] max-w-full"
            style="<?php echo esc_attr($outer_border_style); ?>">

            <div class="flex flex-col p-16 w-full border-solid max-md:px-5 max-md:max-w-full"
            ...
            <div class="w-full tracking-wider max-md:max-w-full">
                <div class="w-full max-md:max-w-full">
                    ...
                    <<?php echo esc_attr($main_heading_tag); ?>
                        ...
                        class="mt-2 text-[68px] font-bold leading-[78px] max-md:max-w-full max-md:text-4xl max-md:leading-[51px] break-words overflow-wrap-anywhere"
                ...
                <div class="mt-4 text-2xl font-medium max-md:max-w-full wp_editor"
            ...
            <div class="flex gap-3 items-start self-start mt-14 text-xl leading-none max-md:mt-10 max-md:max-w-full"
                role="group"
                ...
                <a
                    ...
                    class="flex gap-2 justify-center items-center px-8 py-5 tracking-wide text-center text-white bg-primary min-h-14 w-fit whitespace-nowrap shadow-[10px_14px_24px_rgba(0,0,0,0.25)] max-md:px-5 btn hover:bg-primary-dark focus:bg-primary-dark transition-colors duration-200"
                ...
                <a
                    ...
                    class="flex gap-2 justify-center items-center px-8 py-5 text-[#1D4ED8] bg-[#DBEAFE] min-h-14 w-fit whitespace-nowrap shadow-[20px_14px_24px_rgba(0,0,0,0.08)] max-md:px-5 btn hover:bg-primary-light hover:text-[#FFFFFF] focus:bg-[#DBEAFE] transition-colors duration-200"
