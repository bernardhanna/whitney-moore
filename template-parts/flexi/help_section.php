...
>
<div class="flex flex-col items-center w-full mx-auto max-w-[900px]
            py-12
    ...
    <div class="flex relative flex-col gap-2 justify-center items-center self-stretch max-sm:px-4 max-sm:py-6">
      <div class="flex relative gap-8 items-center w-full max-lg:gap-6 max-lg:items-start max-sm:gap-5 max-lg:flex-col max-md:justify-start">

        <?php if (!empty($heading)) : ?>
          <header
            class="flex relative gap-2 justify-center items-center max-md:w-full max-md:flex-col max-md:items-start"
          >
        ...
        <?php endif; ?>
          <div class="flex flex-col gap-4 justify-between items-center w-full xs:flex-row sm:gap-8 lg:gap-12">
              <div class="flex relative items-start self-stretch w-full lg:w-[353px]">
                <div class="flex relative gap-1 items-start self-stretch w-full">
                  <div class="relative w-full">
                    ...
                    <?php else : ?>
                      ...
                      <ul
                        ...
                        role="listbox"
                        aria-labelledby="<?php echo esc_attr($dropdown_button_id); ?>-label"
                        class="hidden overflow-y-auto absolute left-0 top-full z-50 w-full max-h-60 bg-white border border-t-0 shadow-lg border-primary"
                        tabindex="-1"
                      >
                        <?php if (!empty($items)) : ?>
                          <?php foreach ($items as $it) : ?>
                            <li
                              role="option"
                              class="px-4 py-3 text-base text-black cursor-pointer dropdown-option hover:bg-primary-lighter focus:bg-primary-light max-lg:px-3.5 max-lg:py-2.5 max-sm:px-3 max-sm:py-2"
                              data-url="<?php echo esc_url($it['url']); ?>"
                              tabindex="-1"
                            >
                              <?php echo esc_html($it['title']); ?>
              ...
              <div class="flex relative flex-col gap-2 items-start w-full xs:w-32">
                <button
                  type="button"
